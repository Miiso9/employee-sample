...
export function SalaryCreateModal({ isOpen, onClose, onCreated }: Props) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            onCreated();
            onClose();
            setForm({ emp_no: '', salary: '', from_date: '', to_date: '' });
        } catch (error) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
            ...
            >
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold">Create New Salary</h2>
                    <button
                        onClick={onClose}
